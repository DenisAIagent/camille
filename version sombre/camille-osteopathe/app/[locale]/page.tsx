          ...
          <div className="animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 items-center w-full px-4 sm:px-0">
              ...
              <Button
                asChild
                size="lg"
                className="bg-foreground/5 backdrop-blur-sm border-2 border-foreground/30 text-foreground hover:bg-foreground/20 dark:bg-white/5 dark:border-white/30 dark:text-white/90 dark:hover:bg-white/20 dark:hover:text-white rounded-full px-8 sm:px-12 py-6 sm:py-7 text-base sm:text-lg h-auto transition-smooth hover-scale shadow-premium w-full sm:w-auto whitespace-normal text-center leading-tight"
              >
