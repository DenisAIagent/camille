        ...
        <div className="flex flex-col">
            ...
            <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden parallax-container">
                ...
                <div className="container mx-auto px-4 text-center max-w-4xl relative z-10">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-medium mb-4 text-foreground drop-shadow-lg animate-fade-in-up">
                        {t('h1')}
                    </h1>
                    <p className="text-xl md:text-2xl text-foreground/80 italic drop-shadow animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                        {t('subtitle')}
                    </p>
                </div>
            </section>
            ...
            <div className="container mx-auto px-4 max-w-6xl pt-6 pb-24">
                <div className="space-y-16 md:space-y-20">
                    ...
                    <section className="relative overflow-hidden rounded-[2rem] shadow-premium">
                        <div
                        ...
                        ></div>
                        <div className="relative z-10 p-8 md:p-16 flex items-center justify-center min-h-[400px]">
                            <div className="max-w-4xl mx-auto text-center bg-card/90 dark:bg-card/80 backdrop-blur-md p-8 md:p-12 rounded-[2rem] shadow-lg border border-border/50">
                                <h2 className="text-3xl md:text-4xl font-serif mb-8 text-primary font-medium">{t('h2_role')}</h2>
