  ...
  return (
    <div className="flex flex-col">
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 items-center w-full px-4 sm:px-0">
              ...
              <Button
                asChild
                size="lg"
                className="bg-white/5 backdrop-blur-sm border-2 border-white/30 text-white/90 hover:bg-white/20 hover:text-white rounded-full px-8 sm:px-12 py-6 sm:py-7 text-base sm:text-lg h-auto transition-smooth hover-scale shadow-premium w-full sm:w-auto whitespace-normal text-center leading-tight"
              >
      ...
      <div className="container mx-auto px-4 py-24">
        <FeatureBlock
          imageSrc="/images/photos/camille-24 - Grande.webp"
          imageAlt="Camille Labasse - Ostéopathe"
          title={t('h2_welcome')}
          description={t('welcome')}
          layout="image-left"
          decorationPosition="top-right"
          actionLabel="En savoir plus sur l'ostéopathie"
          actionHref="/osteopathie"
        />
      </div>
