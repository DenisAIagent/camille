...
export default function WhatsAppModal({ isOpen, onClose }: WhatsAppModalProps) {
    ...
    const _t = useTranslations('ContactModals.whatsapp');
    ...
    return (
        <>
            ...
            {/* Modal */}
            <div className="fixed left-1/2 top-1/2 z-[70] w-full max-w-md mx-4 animate-scale-in">
                <div className="bg-background rounded-2xl shadow-2xl border-2 border-border/50 overflow-hidden">
                    {/* Header */}
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    onClick={handleCopy}
                                    className="px-4 py-3 bg-muted hover:bg-muted/80 rounded-lg transition-colors border-2 border-border"
                        ...
                        <div className="space-y-3">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-xl font-medium transition-all hover:shadow-lg hover:-translate-y-0.5"
                            >
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white hover:bg-gray-50 text-gray-800 border-2 border-gray-200 rounded-xl font-medium transition-all hover:shadow-lg hover:-translate-y-0.5"
                            >
