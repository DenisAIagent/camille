                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full bg-muted/50 border-2 border-border rounded-lg px-4 py-3 focus:outline-none focus:border-primary transition-colors"
                                />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    required
                                    rows={5}
                                    className="w-full bg-muted/50 border-2 border-border rounded-lg px-4 py-3 focus:outline-none focus:border-primary transition-colors resize-none"
                                />
                            </div>
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 px-6 py-4 gradient-warm text-white rounded-xl font-medium transition-all hover:shadow-glow hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
